...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        opacities = inverse_sigmoid(0.1 * torch.ones((fused_point_cloud.shape[0], 1), dtype=torch.float, device="cuda")) #α初值为0.1
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_language_feature_3d):
        d = {"xyz": new_xyz,
        ...
        "language_feature_3d": new_language_feature_3d}
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size):
        ...
        print(f'{max_contribute.shape}, {prune_mask.shape}, {self.max_contribute}, {self.denom}')
